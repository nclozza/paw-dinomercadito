...
public class UserDaoJDBCTest {
    ...
    private static final LocalDate BIRTHDATE = LocalDate.parse("1995-9-1");
    ...
    public void testCreate() {
        final User user = userDao.createUser(USERNAME, PASSWORD, EMAIL, PHONE, ADDRESS_ID, BIRTHDATE);
        assertNotNull(user);
